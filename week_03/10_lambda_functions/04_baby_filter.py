...
startswith_m_lambba = lambda str: str.startswith('M')

filtered_name_object = filter(startswith_m_lambba, names)

m_names_list=[]
for i in filtered_name_object:
    m_names_list.append(i)

print(m_names_list)

# print((lambda char, str: str.startswith(char))("t","this"))